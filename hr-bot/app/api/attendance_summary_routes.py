        ...
        for idx, row in df.iterrows():
            try:
                ...
                params = {
                    ...
                    'overtime_count': int(row.get('overtime_count', 0)) if pd.notna(row.get('overtime_count')) else 0,
                    'overtime_hours': float(row.get('overtime_hours', 0)) if pd.notna(row.get('overtime_hours')) else 0
                }
